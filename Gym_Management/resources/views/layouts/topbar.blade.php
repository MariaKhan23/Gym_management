                ...
                <div class="header-controls">
                    ...
                    <div class="cart-wrapper header-links">
                        ...
                        <div class="of-notification-comment">
                            ...
                            <div class="of-nt-scroll">
                                ...
                                <div class="of-nt-flex">
                                    <div class="of-nt-img">
                                        ...
                                        <img src="{{ asset('admin_assets') }}/images/product2.png" alt="">
                                ...
                                <div class="of-nt-flex">
                                    <div class="of-nt-img">
                                        ...
                                        <img src="{{ asset('admin_assets') }}/images/product3.png" alt="">
                                ...
                                <div class="of-nt-flex">
                                    <div class="of-nt-img">
                                        ...
                                        <img src="{{ asset('admin_assets') }}/images/product.png" alt="">
                            ...
                            <div class="int-sop-cart-btn">
                                <a href="cart.html" class="splash-btn">View cart</a>
                                <a href="checkout.html" class="splash-btn">checkout</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="user-info-wrapper header-links">
                        <a href="javascript:void(0);" class="user-info">
                            ...
                            <img src="{{ asset('admin_assets') }}/images/user.jpg" alt="">
                        ...
                        <div class="user-info-box">
                            <div class="drop-down-header">
                                <h4>{{ session('super_admin_username') }}</h4>
                                <p>{{ session('super_admin_email') }}</p>
                            </div>
                            <ul>
                                <li>
                                    <a href="profile.html">
