<aside class="sidebar-wrapper">
    <div class="logo-wrapper">
        <a href="index.html" class="admin-logo">
            ...
            <!-- <img src="{{ asset('admin_assets') }}/images//mini_logo.png" alt=""> -->
    ...
    <div class="side-menu-wrap">
        <ul class="main-menu">
            ...
            <li>
                <a href="{{ route('dashboard')}}">
                    <span class="icon-menu feather-icon">
                        <!-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path><path d="M22 12A10 10 0 0 0 12 2v10z"></path></svg> -->
            ...
            <li>
                ...
                <li>
                        <a href="{{route('admin.equipment.categorie')}}">
 ...
 <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="{{ route('admin.list.vendors') }}">
                            <span class="icon-dash">
                            </span>
                            <span class="menu-text">
                                List Vendors 
...
<!-- 
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="{{ route('admin.list.membership') }}">
                            <span class="icon-dash">
                            </span>
                            <span class="menu-text">
                                List Membership 
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="{{ route('admin.list.members') }}">
                            <span class="icon-dash">  
                            </span>
                            <span class="menu-text">
                                List Members 
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="{{ route('admin.class.calendar') }}">
                            <span class="icon-dash">
                            </span>  
                            <span class="menu-text">
                               Schedule a Class 
...
<!-- 
            ...
            <li>
                <a href="chart.html">
                    <span class="icon-menu feather-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart">
