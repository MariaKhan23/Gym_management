                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="separate-form" method="POST" action="{{route('admin.staff.update',['id' => $staff->id])}}">
                                    @csrf
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <h5 class="from-title mb-1">Staff Registration Form </h5>
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    <label for="member-name" class="col-form-label">Full Name</label>
                                                    <input class="form-control" type="text" placeholder="Staff Full Name" id="member-name" name="staff_name" value="{{$staff->staff_name}}">
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" placeholder="Staff Contact" id="company-name" name="staff_contact" value="{{$staff->staff_contact}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="form-group"> 
                                                    ...
                                                    <input class="form-control" type="email" placeholder="Staff Email" id="another-number" name="staff_email" value="{{$staff->staff_email}}">
                                                </div>
                                            </div>  
