                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="separate-form" method="POST" action="{{route('admin.membership.save')}}">
                                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="Membership Title" id="member-name" name="membership_title">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" placeholder="Membership Months" id="company-name" name="membership_months" min="1" max="12">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" placeholder="Total amount" id="another-number" name="total_amount">
                                                </div>
                                            </div>
