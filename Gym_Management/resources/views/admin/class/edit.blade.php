                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="separate-form" method="POST" action="{{route('admin.class.update',['id' => $id_finder->id])}}">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="Class Name" id="company-name" name="class_name" value="{{$id_finder->class_name}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="trainer" class="form-control">
                                                        ...
                                                        <option value="{{ $trainer->id }}" @if($trainer->staff_name == $id_finder->staffer->staff_name) selected @endif>
                                                            {{ $trainer->staff_name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="time-input">
                                                        <select class="form-control" name="hours">
                                                            @for ($i = 0; $i < 24; $i++) <option value="{{ $i }}" {{ old('hours', $id_finder->hours) == $i ? 'selected' : '' }}>
                                                        ...
                                                        <select class="form-control" name="minutes">
                                                            @for ($i = 0; $i < 60; $i +=5) <option value="{{ $i }}" {{ old('minutes', $id_finder->minutes) == $i ? 'selected' : '' }}>
                                                                {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}
                                                                </option>
                                                                @endfor
                                                        </select>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" placeholder="Class Capacity" id="another-number" name="class_capacity" value="{{$id_finder->class_capacity}}">
                                                </div>
                                            </div>
                                        </div>
