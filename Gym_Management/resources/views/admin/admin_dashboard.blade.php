                        ...
                        <!-- <div class="card splash-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="splash-title">Equipments</h5>
                                    <h4 class="splash-card-title">66k</h4>
                                </div>
                            </div>
                        </div> -->
                        <!-- card  -->
                        ...
                        <!-- equipments Card  -->
                         <div class="card splash-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="splash-title"><a href="{{route('admin.equipment.list')}}">Equipments</a></h5>
                                    <h4 class="splash-card-title">{{$equipments}}</h4>
                                </div>
                            </div>  
                        </div>
                        <!-- equipment card end -->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card splash-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="splash-title"><a href="{{route('admin.list.vendors')}}">Vendors</a></h5>
                                    <h4 class="splash-card-title">{{$Vendors}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card splash-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="splash-title"><a href="{{ route('admin.list.membership')}}">Memberships</a></h5>
                                    <h4 class="splash-card-title">{{$Memberships}}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card splash-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="splash-title">Total Revenue</h5>
                                    <h4 class="splash-card-title">10k</h4>
                                </div>
                            </div>
                        </div>
                    </div>
